                ...
                <div className={`z-20 ${dark ? "bg-gray-200 duration-200 ease-in-out" : "bg-zinc-900 duration-200 ease-in-out"} py-5 w-full h-[83vh] lg:h-auto px-10 rounded-xl md:py-5 lg:py-10 content overflow-y-auto flex flex-col justify-start items-center gap-2 lg:gap-5 relative`}>
                    ...
                    <div className="w-full h-auto py-2 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 justify-items-center gap-5">
                        ...
                        <div on className={`w-full px-5 h-36 rounded-md ${dark ? "bg-white" : "bg-black"} duration-200 overflow-hidden ease-in-out hover:shadow-lg flex flex-col justify-evenly px-5 items-center`}>
                            <p className={`${dark ? "text-black" : "text-white"} duration-200 ease-in-out text-2xl sm:text-xl lg:text-2xl text-center`}>MongoDB</p>
                            <p className={`${dark ? "bg-black text-white" : "bg-white text-black"} px-5 md:px-8 cursor-pointer py-2 text-center duration-200 ease-in-out rounded-full text-[12px]`} onClick={() => openPage('/quiz/database/mongodb')}>Start Quiz</p>
                        </div>

                        <div on className={`w-full px-5 h-36 rounded-md ${dark ? "bg-white" : "bg-black"} duration-200 overflow-hidden ease-in-out hover:shadow-lg flex flex-col justify-evenly px-5 items-center`}>
                            <p className={`${dark ? "text-black" : "text-white"} duration-200 ease-in-out text-2xl sm:text-xl lg:text-2xl text-center`}>MySQL</p>
                            <p className={`${dark ? "bg-black text-white" : "bg-white text-black"} px-5 md:px-8 cursor-pointer py-2 text-center duration-200 ease-in-out rounded-full text-[12px]`} onClick={() => openPage('/quiz/database/mysql')}>Start Quiz</p>
                        </div>
                        ...
                        <div className={`w-full px-5 h-36 rounded-md ${dark ? "bg-white" : "bg-black"} duration-200 overflow-hidden ease-in-out hover:shadow-lg flex flex-col justify-evenly px-5 items-center`}>
                            <p className={`${dark ? "text-black" : "text-white"} duration-200 ease-in-out text-2xl sm:text-xl lg:text-2xl text-center`}>PostgreSQL</p>
                            <p className={`${dark ? "bg-black text-white" : "bg-white text-black"} px-5 md:px-8 cursor-pointer py-2 text-center duration-200 ease-in-out rounded-full text-[12px]`} onClick={() => openPage('/quiz/database/postgresql')}>Start Quiz</p>
                        </div>
